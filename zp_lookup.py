...
def create_zp_interpolator(band, phase):
    ...
    # should be one of '3band', '2band', 'neowiser', 'neowiser2', 'neowiser3', 'neowiser4', 'neowiser5', 'neowiser6', 'neowiser7', 'neowiser8', 'neowiser9', 'neowiser10', 'neowiser11'
    assert (phase == '3band') or (phase == '2band') or (phase == 'neowiser') or (phase == 'neowiser2') or (phase == 'neowiser3') or (phase == 'neowiser4') or (phase == 'neowiser5') or (phase == 'neowiser6') or (phase == 'neowiser7') or (phase == 'neowiser8') or (phase == 'neowiser9') or (phase == 'neowiser10') or (phase == 'neowiser11')
...
class ZPLookUp:
    ...
    def __init__(self, band, poly=False):
        ...
        self.zp_neowiser11 = (create_zp_interpolator(self.band, 'neowiser11') if not self.poly else
                              PiecewisePolynomialInterpolator(self.band, 'neowiser11'))
    ...
    def zp_interpolator_phase(self, phase):
        ...
        elif (phase == 'neowiser10'):
            return self.zp_neowiser10
        else:
            return self.zp_neowiser11
